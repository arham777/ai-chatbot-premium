      ...
      <div className="flex items-end space-x-3">
        <div className="flex-1 relative">
          <textarea
            ...
            className="w-full p-3 pr-12 border border-slate-200 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent max-h-32 min-h-[44px] bg-slate-50 hover:bg-white transition-colors duration-200 placeholder-slate-400"
            rows={1}
            style={{
              height: 'auto',
              minHeight: '44px',
