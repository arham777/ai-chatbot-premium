...
const ChatWindow = ({ messages, onSendMessage, onClose, isTyping }: ChatWindowProps) => {
  ...
  const chatWindowClasses = isExpanded 
    ...
    : "fixed bottom-4 right-4 w-full max-w-[400px] h-[600px] max-h-[calc(100vh-2rem)] bg-white shadow-2xl flex flex-col z-50 animate-slide-in-right border border-slate-200 rounded-2xl overflow-hidden sm:w-[400px]";
  ...
  return (
    <div className={chatWindowClasses}>
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gradient-to-b from-slate-50 to-white min-h-0">
        {messages.length === 0 ? (
